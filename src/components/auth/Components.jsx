...
export const GhostButton = styled(Button)`
  ...
  border-color: ${theme.palette.primary.light}; // Ensure this is visible against the background
  color: "white"; // Visible against the blue background

  &:hover {
    background-color: ${theme.palette.primary.light}; // This will be visible on hover
    color: #ffffff;
  }
`;
